...
export default function Component() {
  ...
  <Text sx={{"color": "white"}}>
  {`Welcome to the Ethereum Trading page`}
</Text>
  <HStack>
  <Box sx={{"borderWidth": "thick", "borderColor": "pink", "borderRadius": "3px"}}>
  <Image src={`/ethgraph.png`} sx={{"width": "600px", "height": "auto"}}/>
</Box>
  <Box sx={{"borderWidth": "thick", "borderColor": "#990000", "borderRadius": "3px", "paddingLeft": "8%", "bg": "#404040", "width": "300px"}}>
  <Text sx={{"color": "white"}}>
  {`some data`}
</Text>
  <Button onClick={(_e) => addEvents([Event("state.app_state.change_text", {id:2})], (_e))}>
